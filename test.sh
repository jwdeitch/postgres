...
/usr/local/pgsql/bin/psql -c "alter system set superuser_reserved_connections = 10;"
/usr/local/pgsql/bin/psql -c "alter system set max_connections = 5;"
